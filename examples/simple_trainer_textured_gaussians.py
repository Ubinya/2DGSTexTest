...
def create_splats_with_optimizers(
    ...
    params = [
        ...
        # ("depth_scaler", torch.nn.Parameter(torch.ones((N,))), 5e-2),
    ]
...
class Runner:
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            if cfg.depth_loss:
                ...
                # if cfg.depth_mode == 'npz':
                #     desc += f"depth scaler={self.splats["depth_scaler"][0].item():.3f}| "
            if cfg.dist_loss:
    ...
    def render_traj(self, step: int):
        ...
        writer = imageio.get_writer(f"{video_dir}/traj_{step}.mp4")
